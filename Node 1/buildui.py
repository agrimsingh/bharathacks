import pandas as pd
import numpy as np
from pa.charts.nvd3 import TwoAxisFocus, PieChart
from pa.filters import SelectButton
...
def make_nv_layout(filename):
    ...
    # Make a button
    choices = ["Employees",'prateek','agrim']
    btn = SelectButton("Data", choices, "Data", "Employees")
    ui.add_filter(btn)
...
def get_layouts(mod, filename):
    ...
    _layouts = {"nvd3":{"layout": [nv_props], "title": "EAR Analytics"}}
